...
export const generateAccessToken :IGenerateAccessToken = (id,login)=>{
    ...
    return jwt.sign(payload, access_token.secret_key,{ expiresIn:access_token.time})
}
...
export const generateRefreshToken :IGenerateRefreshToken = (id)=>{
    ...
    return jwt.sign(payload, refresh_token.secret_key,{ expiresIn:refresh_token.time})
}