...
class TasksRequest {
    addTask(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.body.title && typeof req.body.done === 'boolean' && ((_a = req.user) === null || _a === void 0 ? void 0 : _a.id)) {
                try {
                    yield index_1.db.query(`INSERT INTO tasks (title,done,user_id) VALUES ($1,$2,$3)`, [
                        req.body.title,
                        req.body.done,
                        req.user.id
                    ]);
    ...
    deleteTaskOrTasks(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.query.id) {
                try {
                    yield index_1.db.query(`DELETE FROM tasks WHERE id=$1`, [
                        +req.query.id,
                    ]);
                ...
                try {
                    yield index_1.db.query(`DELETE FROM tasks`);
    ...
    getTasks(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.user) {
                try {
                    const tasks = yield index_1.db.query(`SELECT * FROM tasks WHERE user_id=$1`, [
                        req.user.id,
                    ]);
                    const data = tasks;
    ...
    updateTasks(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (req.body.id && typeof req.body.done === 'boolean') {
                try {
                    yield index_1.db.query(`UPDATE tasks SET done=$1 WHERE id=$2`, [
                        req.body.done,
                        req.body.id
                    ]);
